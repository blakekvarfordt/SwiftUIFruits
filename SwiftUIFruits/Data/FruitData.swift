    ...
    Fruit(
      ...
      Fruit(
        ...
        description: """
          ...
          """,
        colors: [Color("ColorStrawberryLight"), Color("ColorStrawberryDark")],
      ...
      Fruit(
        ...
        description: """
          ...
          """,
        colors: [Color("ColorLemonLight"), Color("ColorLemonDark")],
      ...
      Fruit(
        ...
        description: """
          ...
          """,
        colors: [Color("ColorPlumLight"), Color("ColorPlumDark")],
      ...
      Fruit(
        ...
        """,
        colors: [Color("ColorLimeLight"), Color("ColorLimeDark")],
      ...
      Fruit(
        ...
        description: """
          ...
          """,
        colors: [Color("ColorPomegranateLight"), Color("ColorPomegranateDark")],
      ...
      Fruit(
        ...
        description: """
          ...
          """,
        colors: [Color("ColorPearLight"), Color("ColorPearDark")],
      ...
      Fruit(
        ...
        description: """
          ...
          """,
        colors: [Color("ColorGooseberryLight"), Color("ColorGooseberryDark")],
      ...
      Fruit(
        ...
        description: """
          ...
          """,
        colors: [Color("ColorMangoLight"), Color("ColorMangoDark")],
      ...
      Fruit(
        ...
        description: """
          ...
          """,
        colors: [Color("ColorWatermelonLight"), Color("ColorWatermelonDark")],
      ...
      Fruit(
        ...
        description: """
          ...
          """,
        colors: [Color("ColorCherryLight"), Color("ColorCherryDark")],
      ...
      Fruit(
        ...
        description: """
          ...
          """,
        colors: [Color("ColorGrapefruitLight"), Color("ColorGrapefruitDark")],
      ...
      Fruit(
        ...
        description: """
          ...
          """,
        colors: [Color("ColorAppleLight"), Color("ColorAppleDark")],
